...
export default function AppStoreSlideShow() {
  ...
  // const filteredImageProps: imgPropsType[] = [];
  // let i = state;
  // while (filteredImageProps.length < 8) {
  //   filteredImageProps.push(imgProps[i]);
  ...
  return (
    <>
      <div className="[clip-path:inset(2px)] relative grid grid-cols-4 grid-rows-2 w-full max-w-[450px] aspect-[2] m-10 [&>div]:border-r [&>div]:border-b [&>div]:border-gray bg-white overflow-hidden">
        ...
        <CrossSVG
          className="absolute rounded-full size-6"
          style={{
            left: "calc(25% - 12px)",
            top: "calc(50% - 12px)",
          }}
